...
Session.setDefault("currentTodoID",null);
Session.setDefault("noteStatusObj_total",0);
Session.setDefault("noteStatusObj_new",0);
Session.setDefault("noteStatusObj_closed",0);
Session.setDefault("noteStatusObj_due",0);
...
Session.setDefault("activeTabTitle", "All tasks");
